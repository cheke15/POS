      ...
      if (this.sale.warehouse_id != "" && this.sale.warehouse_id != null) {
        this.timer = setTimeout(function () {
          ...
          if (product_filter.length === 1) {
            ...
            if (_this10.product_filter.length <= 0) {
              _this10.makeToast("warning", "Product Not Found", "Warning");
            }
          }
        }, 800);
      } else {
...
var render = function render() {
  ...
  }, [_vm._v(_vm._s(parseFloat(_vm.payment.received_amount - _vm.payment.amount).toFixed(2)))])]) : _vm._e(), _vm._v(" "), _vm.payment.status != 'pending' && _vm.payment.Reglement == 'credit card' && _vm.sale.statut == 'completed' ? _c('b-col', {
    staticClass: "mt-3",
    attrs: {
      "md": "12"
    }
