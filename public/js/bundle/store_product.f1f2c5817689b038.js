...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    calculateTotalPrice: function calculateTotalPrice() {
      var price = parseFloat(this.product.price) || 0;
      var iva = parseFloat(this.product.iva) || 0;
      var ieps = parseFloat(this.product.ieps) || 0;
      var ish = parseFloat(this.product.ish) || 0;
      var totalTax = price * (iva + ieps + ish) / 100;
    ...
    formatNumber: function formatNumber(number, dec) {
      ...
      var formatted = value[1] || "";
      if (formatted.length > dec) return "".concat(value[0], ".").concat(formatted.substr(0, dec));
      while (formatted.length < dec) formatted += "0";
      return "".concat(value[0], ".").concat(formatted);
    },
    // Método para convertir el valor a decimal
    convertToDecimal: function convertToDecimal(value) {
      if (typeof value === "string" && value.trim() !== "") {
        ...
        if (regex.test(value)) {
          ...
          throw new Error("Formato inválido. Solo se permiten números con o sin decimales y opcionalmente un '%' al final.");
        }
      }
      return 0;
    },
    ...
    get_products_materiels: function get_products_materiels() {
      var _this = this;
      axios.get("get_products_materiels").then(function (_ref) {
        var data = _ref.data;
        _this.products_ing = data;
      });
    },
    // Search Products
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              if (valid) {
                _this3.product.image = e.target.files[0];
              } else {
                _this3.product.image = "";
              }
            case 5:
            case "end":
    ...
    Create_Product: function Create_Product() {
      ...
      axios.post("products", self.data).then(function (response) {
        ...
        alert("Precio total: ".concat(totalPrice));
        _this7.$router.push({
          name: "index_products"
        });
...
var render = function render() {
  ...
  return _c('div', {
    ...
    }], null, false, 2808448865)
  })], 1), _vm._v(" "), _vm.product.type == 'is_single' || _vm.product.type == 'is_combo' ? _c('b-col', {
    staticClass: "mb-2",
    attrs: {
      "md": "6"
    }
    ...
    on: {
      "input": function input($event) {
        return _vm.validateNumber('IVA');
      }
    },
    model: {
      value: _vm.product.iva,
      callback: function callback($$v) {
        _vm.$set(_vm.product, "iva", _vm._n($$v));
      },
      expression: "product.iva"
    }
  })], 1)], 1), _vm._v(" "), _c('div', [_c('b-form-group', {
    attrs: {
      "label": "IEPS (%)"
    }
  }, [_c('b-form-input', {
    attrs: {
      "type": "text",
      "placeholder": "Ingrese el porcentaje de IEPS"
    },
    on: {
      "input": function input($event) {
        return _vm.validateNumber('ieps');
      }
    },
    model: {
      value: _vm.product.ieps,
      callback: function callback($$v) {
        _vm.$set(_vm.product, "ieps", _vm._n($$v));
      },
      expression: "product.ieps"
    }
  })], 1)], 1), _vm._v(" "), _c('div', [_c('b-form-group', {
    attrs: {
      "label": "ISH (%)"
    ...
    attrs: {
      "type": "text",
      "placeholder": "Ingrese el porcentaje de ISH"
    },
    on: {
      "input": function input($event) {
        return _vm.validateNumber('ISH');
      }
    },
    model: {
      value: _vm.product.ish,
      callback: function callback($$v) {
        _vm.$set(_vm.product, "ish", _vm._n($$v));
      },
      expression: "product.ish"
    }
    ...
    attrs: {
      "type": "text",
      "value": _vm.calculateTotalPrice(),
      "readonly": ""
    }
  })], 1)], 1), _vm._v(" "), _vm.product.type != 'is_service' ? _c('b-col', {
    staticClass: "mb-2",
    attrs: {
      "md": "6"
    }
    ...
    staticClass: "d-flex"
  }), _vm._v(" "), _vm.product.type == 'is_variant' ? _c('div', {
    staticClass: "col-md-9 mb-3 mt-3"
  }, [_c('div', {
    staticClass: "d-flex"
  }, [_c('input', {
  ...
  }, [_vm._v(_vm._s(_vm.$t('Add')))])])]) : _vm._e(), _vm._v("\n<\n                "), _vm.product.type == 'is_variant' ? _c('div', {
  ...
  })], 2)])])]) : _vm._e()]) : _vm._e()], 1)], 1)], 1), _vm._v(" "), _vm.product.type != 'is_combo' ? _c('b-card', {
    staticClass: "mt-3"
  }, [_c('b-row', [_c('b-col', {
    attrs: {
      "md": "12 mb-2"
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Add_product_vue_vue_type_style_index_0_id_45a5ea63_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Add_product.vue?vue&type=style&index=0&id=45a5ea63&lang=css */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/products/Add_product.vue?vue&type=style&index=0&id=45a5ea63&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Add_product_vue_vue_type_style_index_0_id_45a5ea63_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Add_product_vue_vue_type_style_index_0_id_45a5ea63_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader/dist/cjs.js!../../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Add_product.vue?vue&type=style&index=0&id=45a5ea63&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/products/Add_product.vue?vue&type=style&index=0&id=45a5ea63&lang=css");
