...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    //-----------------------------------Delete Product ------------------------------\\
    delete_Product: function delete_Product(code) {
      ...
      if (this.barcode.warehouse_id != "" && this.barcode.warehouse_id != null) {
        this.timer = setTimeout(function () {
          ...
          if (product_filter.length === 1) {
            ...
            var tokens = _this2.search_input.toLowerCase().split(' ');
            _this2.product_filter = _this2.products.filter(function (product) {
              return tokens.every(function (token) {
                return product.name.toLowerCase().includes(token) || product.code.toLowerCase().includes(token) || product.barcode.toLowerCase().includes(token) || product.note && product.note.toLowerCase().includes(token);
              });
            ...
            if (_this2.product_filter.length <= 0) {
              _this2.makeToast("warning", "Product Not Found", "Warning");
            }
          }
        }, 800);
      } else {
    ...
    SearchProduct: function SearchProduct(result) {
      var existingProduct = this.products_added.find(function (product) {
        return product.code === result.code;
      });
      if (existingProduct) {
    ...
    Get_Products_By_Warehouse: function Get_Products_By_Warehouse(id) {
      ...
      axios.get("get_Products_by_warehouse/" + id + "?stock=" + 0 + "&product_service=" + 1 + "&product_combo=" + 1).then(function (response) {
    ...
    generatePages: function generatePages() {
      var allBarcodes = [];
      this.products_added.forEach(function (product) {
        for (var i = 0; i < product.qte; i++) {
          allBarcodes.push({
            name: product.name,
...
var render = function render() {
  ...
  return _c('div', {
  ...
  }) : _vm._e(), _vm._v(" "), !_vm.isLoading ? _c('b-row', [_c('b-modal', {
    attrs: {
      "hide-footer": "",
      "id": "open_scan",
      "size": "md",
  ...
  })])])]), _vm._v(" "), _c('tbody', [_vm.products_added.length === 0 ? _c('tr', [_c('td', {
    attrs: {
      "colspan": "4"
    }
  }, [_vm._v(_vm._s(_vm.$t('NodataAvailable')))])]) : _vm._e(), _vm._v(" "), _vm._l(_vm.products_added, function (product) {
    return _c('tr', {
      key: product.code
    }, [_c('td', [_vm._v(_vm._s(product.name))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(product.code))]), _vm._v(" "), _c('td', [_c('input', {
      directives: [{
        name: "model",
        rawName: "v-model.number",
        value: product.qte,
        expression: "product.qte",
        modifiers: {
          "number": true
        }
      }],
      ...
      on: {
        "input": function input($event) {
          ...
          _vm.$set(product, "qte", _vm._n($event.target.value));
        },
      ...
      on: {
        "click": function click($event) {
          return _vm.delete_Product(product.code);
        }
      }
    })])]);
  })], 2)])])]), _vm._v(" "), _c('b-col', {
    ...
    domProps: {
      "checked": Array.isArray(_vm.show_price) ? _vm._i(_vm.show_price, null) > -1 : _vm.show_price
    },
    on: {
      "change": function change($event) {
        var $$a = _vm.show_price,
          $$el = $event.target,
        ...
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && (_vm.show_price = $$a.concat([$$v]));
          } else {
            $$i > -1 && (_vm.show_price = $$a.slice(0, $$i).concat($$a.slice($$i + 1)));
          }
        } else {
          _vm.show_price = $$c;
        }
  ...
  }), _c('h5', [_vm._v("Display Price ")]), _c('span', {
    ...
    return _c('div', {
    ...
    }, _vm._l(page, function (barcode, index) {
      return _c('div', {
        key: index,
        staticClass: "barcode-item",
        "class": _vm.class_sheet
      }, [_c('div', {
        staticClass: "head_barcode text-left",
        staticStyle: {
          "padding-left": "10px",
          "font-weight": "bold",
          "font-size": "10px"
      ...
      }, [_vm._v(_vm._s(barcode.name))]), _vm._v(" "), _vm.show_price ? _c('span', {
        staticClass: "barcode-price"
      }, [_vm._v(_vm._s(_vm.currentUser.currency) + " " + _vm._s(barcode.Net_price))]) : _vm._e()]), _vm._v(" "), _c('barcode', {
        staticClass: "barcode",
        attrs: {
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_barcode_vue_vue_type_style_index_0_id_3a52cd32_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./barcode.vue?vue&type=style&index=0&id=3a52cd32&lang=css */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/products/barcode.vue?vue&type=style&index=0&id=3a52cd32&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_barcode_vue_vue_type_style_index_0_id_3a52cd32_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony import */ var _barcode_vue_vue_type_style_index_0_id_3a52cd32_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./barcode.vue?vue&type=style&index=0&id=3a52cd32&lang=css */ "./resources/src/views/app/pages/products/barcode.vue?vue&type=style&index=0&id=3a52cd32&lang=css");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_barcode_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./barcode.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/products/barcode.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_barcode_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_barcode_vue_vue_type_template_id_3a52cd32__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_barcode_vue_vue_type_template_id_3a52cd32__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_barcode_vue_vue_type_template_id_3a52cd32__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./barcode.vue?vue&type=template&id=3a52cd32 */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/products/barcode.vue?vue&type=template&id=3a52cd32");


/***/ }),

/***/ "./resources/src/views/app/pages/products/barcode.vue?vue&type=style&index=0&id=3a52cd32&lang=css":
/*!********************************************************************************************************!*\
  !*** ./resources/src/views/app/pages/products/barcode.vue?vue&type=style&index=0&id=3a52cd32&lang=css ***!
  \********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_barcode_vue_vue_type_style_index_0_id_3a52cd32_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader/dist/cjs.js!../../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./barcode.vue?vue&type=style&index=0&id=3a52cd32&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/products/barcode.vue?vue&type=style&index=0&id=3a52cd32&lang=css");
