...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapActions)(["changeSidebarProperties", "changeThemeMode", "logout"])), {}, (_objectSpread2 = {
    ...
    setTimeout(function () {
      _this10.$bvModal.show("show_draft_sales");
    }, 1000);
    ...
    axios.get("get_draft_sales?page=" + page + "&limit=" + this.limit).then(function (response) {
      _this11.draft_sales = response.data.draft_sales;
      _this11.totalRows_draft_sales = response.data.totalRows;
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
    ...
    this.$swal({
      ...
      if (result.value) {
        ...
        axios["delete"]("remove_draft_sale/" + id).then(function () {
          _this12.$swal(_this12.$t("Delete.Deleted"), _this12.$t("Draft_Sale_Deleted"), "success");
    ...
    this.$refs.Add_payment.validate().then(function (success) {
      if (!success) {
        ...
        if (_this14.payment.amount > _this14.payment.received_amount) {
          _this14.makeToast("warning", _this14.$t("Paying_amount_is_greater_than_Received_amount"), _this14.$t("Warning"));
          _this14.payment.received_amount = 0;
          nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
        } else if (_this14.payment.amount > _this14.GrandTotal) {
          _this14.makeToast("warning", _this14.$t("Paying_amount_is_greater_than_Grand_Total"), _this14.$t("Warning"));
          _this14.payment.amount = 0;
          nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
        } else {
          _this14.CreatePOS();
        }
    ...
    axios.post("clients", {
      ...
      _this16.Get_Client_Without_Paginate();
    ...
    axios.get("get_today_sales").then(function (response) {
      _this18.today_sales = response.data;
      setTimeout(function () {
        _this18.$bvModal.show("modal_today_sales");
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
      }, 1000);
    })["catch"](function (error) {});
    ...
    axios.get("get_Products_by_warehouse/" + id + "?stock=" + 1 + "&is_sale=" + 1 + "&product_service=" + 1 + "&product_combo=" + 1).then(function (response) {
      _this19.products_pos = response.data;
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
    })["catch"](function (error) {});
    ...
    setTimeout(function () {
      _this22.$bvModal.show("form_Update_Detail");
    }, 1000);
    ...
    this.CaclulTotal();
    setTimeout(function () {
      _this23.$bvModal.hide("form_Update_Detail");
    }, 1000);
    ...
    axios.get("sales_print_invoice/" + id).then(function (response) {
      _this24.invoice_pos = response.data;
      _this24.payments = response.data.payments;
      _this24.pos_settings = response.data.pos_settings;
      setTimeout(function () {
        // Complete the animation of the  progress bar.
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
        _this24.$bvModal.show("Show_invoice");
      }, 500);
      if (response.data.pos_settings.is_printable) {
        setTimeout(function () {
          return _this24.print_pos();
        }, 1000);
      }
    })["catch"](function () {
      // Complete the animation of the  progress bar.
    ...
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      var _yield$_this25$stripe, token, error;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _this25.paymentProcessing = true;
            _context3.next = 3;
            return _this25.stripe.createToken(_this25.cardElement);
          case 3:
            _yield$_this25$stripe = _context3.sent;
            token = _yield$_this25$stripe.token;
            error = _yield$_this25$stripe.error;
            if (error) {
              ...
              axios.post("pos/create_pos", {
                client_id: _this25.sale.client_id,
                warehouse_id: _this25.sale.warehouse_id,
                tax_rate: _this25.sale.tax_rate ? _this25.sale.tax_rate : 0,
                TaxNet: _this25.sale.TaxNet ? _this25.sale.TaxNet : 0,
                discount: _this25.sale.discount ? _this25.sale.discount : 0,
                shipping: _this25.sale.shipping ? _this25.sale.shipping : 0,
                details: _this25.details,
                GrandTotal: _this25.GrandTotal,
                payment: _this25.payment,
                account_id: _this25.payment.account_id,
                amount: parseFloat(_this25.payment.amount).toFixed(2),
                received_amount: parseFloat(_this25.payment.received_amount).toFixed(2),
                change: parseFloat(_this25.payment.received_amount - _this25.payment.amount).toFixed(2),
                token: token.id,
                ...
                if (response.data.success === true) {
                  // Complete the animation of theprogress bar.
                  nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
                  _this25.Invoice_POS(response.data.id);
    ...
    if (this.payment.Reglement == "credit card" && this.is_new_credit_card) {
      ...
      axios.post("pos/create_pos", {
        ...
        if (response.data.success === true) {
          // Complete the animation of theprogress bar.
          nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
          _this26.paymentProcessing = false;
          _this26.Invoice_POS(response.data.id);
          _this26.$bvModal.hide("Add_Payment");
          _this26.Reset_Pos();
        }
      })["catch"](function (error) {
        // Complete the animation of theprogress bar.
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
        _this26.paymentProcessing = false;
        _this26.makeToast("danger", _this26.$t("InvalidData"), _this26.$t("Failed"));
      });
    }
    ...
    axios.get("/show_product_data/" + product_id + "/" + variant_id).then(function (response) {
      _this27.product.discount = 0;
      _this27.product.DiscountNet = 0;
      _this27.product.discount_Method = "2";
      _this27.product.product_id = response.data.id;
      _this27.product.product_type = response.data.product_type;
      _this27.product.name = response.data.name;
      _this27.product.Net_price = response.data.Net_price;
      _this27.product.Total_price = response.data.Total_price;
      _this27.product.Unit_price = response.data.Unit_price;
      _this27.product.taxe = response.data.tax_price;
      _this27.product.tax_method = response.data.tax_method;
      _this27.product.tax_percent = response.data.tax_percent;
      _this27.product.unitSale = response.data.unitSale;
      _this27.product.product_variant_id = variant_id;
      _this27.product.code = response.data.code;
      _this27.product.fix_price = response.data.fix_price;
      _this27.product.sale_unit_id = response.data.sale_unit_id;
      _this27.product.is_imei = response.data.is_imei;
      _this27.product.imei_number = '';
      _this27.add_product(response.data.code);
      _this27.CaclulTotal();
      // Complete the animation of theprogress bar.
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
    });
    ...
    if (this.sale.warehouse_id != "" && this.sale.warehouse_id != null) {
      this.timer = setTimeout(function () {
        var product_filter = _this29.products_pos.filter(function (product) {
          return product.code === _this29.search_input || product.barcode.includes(_this29.search_input);
        });
        if (product_filter.length === 1) {
          _this29.Check_Product_Exist(product_filter[0], product_filter[0].id);
        } else {
          _this29.product_filter = _this29.products_pos.filter(function (product) {
            return product.name.toLowerCase().includes(_this29.search_input.toLowerCase()) || product.code.toLowerCase().includes(_this29.search_input.toLowerCase()) || product.barcode.toLowerCase().includes(_this29.search_input.toLowerCase());
          });

          // Check if product_filter is empty and show alert
          if (_this29.product_filter.length <= 0) {
            _this29.makeToast("warning", "Product Not Found", "Warning");
          }
        }
      }, 800);
    } else {
    ...
    axios.get("pos/get_products_pos?page=" + page + "&category_id=" + this.category_id + "&brand_id=" + this.brand_id + "&warehouse_id=" + this.sale.warehouse_id + "&stock=" + 1 + "&product_service=" + 1 + "&product_combo=" + 1).then(function (response) {
      _this30.products = response.data.products;
      _this30.product_totalRows = response.data.totalRows;
      _this30.Product_paginatePerPage();
      // Complete the animation of theprogress bar.
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
    })["catch"](function (response) {
      // Complete the animation of theprogress bar.
    ...
    axios.get("pos/data_create_pos").then(function (response) {
      ...
      _this31.accounts = response.data.accounts;
      _this31.warehouses = response.data.warehouses;
      _this31.categories = response.data.categories;
      _this31.brands = response.data.brands;
      _this31.sale.warehouse_id = response.data.defaultWarehouse;
      _this31.sale.client_id = response.data.defaultClient;
      _this31.client_name = response.data.default_client_name;
      _this31.product_perPage = response.data.products_per_page;
      _this31.getProducts();
      if (response.data.defaultWarehouse != "") {
        _this31.Get_Products_By_Warehouse(response.data.defaultWarehouse);
      }
      _this31.paginate_Brands(_this31.brand_perPage, 0);
      _this31.paginate_Category(_this31.category_perPage, 0);
      _this31.stripe_key = response.data.stripe_key;
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_pos_vue_vue_type_style_index_0_id_4cc49487_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./pos.vue?vue&type=style&index=0&id=4cc49487&lang=css */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/pos.vue?vue&type=style&index=0&id=4cc49487&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_pos_vue_vue_type_style_index_0_id_4cc49487_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_pos_vue_vue_type_style_index_0_id_4cc49487_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./pos.vue?vue&type=style&index=0&id=4cc49487&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/pos.vue?vue&type=style&index=0&id=4cc49487&lang=css");
